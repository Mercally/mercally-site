...
const T = {
  es: {
    ...
    contactHref: 'mailto:josuemercally@outlook.com?subject=Diagn%C3%B3stico%20t%C3%A9cnico',
  ...
  en: {
    ...
    contactHref: 'mailto:josuemercally@outlook.com?subject=Technical%20diagnosis',
